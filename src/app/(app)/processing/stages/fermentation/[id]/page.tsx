...
import {
  ...
  FlaskConical, Calendar, Hash, Thermometer, Droplets, Clock, Cog, User, FileText,
} from 'lucide-react'
    ...
    try {
      ...
      if (data.success) {
        ...
        if (found) {
          ...
          router.push('/processing/stages/fermentation')
        }
      } else {
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Button
              variant="ghost"
              size="sm"
              onClick={() => router.push('/processing/stages/fermentation')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="rounded-xl border-0 shadow-sm">
            ...
            <CardContent className="space-y-1">
              ...
              <InfoRow label={t2('Loại giai đoạn', 'Stage Type')} value={record.stageType} icon={<FlaskConical className="w-3.5 h-3.5" />} />
