    ...
    try {
      ...
      if (data.success) {
        ...
        if (found) {
          ...
          router.push('/processing/stages/retail')
        }
      }
    } catch {
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="sm" onClick={() => router.push('/processing/stages/retail')} className="text-muted-foreground hover:text-foreground gap-1 -ml-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button className="bg-primary text-primary-foreground hover:bg-primary/90 gap-2 rounded-xl shadow-sm text-xs" onClick={() => router.push('/processing/stages/retail')}>
