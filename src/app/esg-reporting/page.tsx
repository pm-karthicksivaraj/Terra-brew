...
export default function ESGReportingPage() {
  ...
  const handleGenerateReport = () => {
    ...
    setTimeout(() => {
      setGenerating(false)
      toast.success('Report generation started — PDF will be available for download', {
        duration: 5000,
      })
    }, 2000)
  }
                ...
                <MotionCard {...hoverScale} className="rounded-xl border shadow-sm">
                  ...
                  <CardContent>
                    <Button
                      variant="outline"
                      className="w-full text-xs gap-1"
                      onClick={() => toast.info('PDF export will be available after report generation')}
                    >
                ...
                <MotionCard {...hoverScale} className="rounded-xl border shadow-sm">
                  ...
                  <CardContent>
                    <Button
                      variant="outline"
                      className="w-full text-xs gap-1"
                      onClick={() => toast.info('Excel export will be available after report generation')}
                    >
